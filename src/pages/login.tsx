...
const Login = () => {
  ...
  const policies = [
    '1. กวศ. จะขอเข้าถึงข้อมูลส่วนตัวของท่านผ่านระบบ CUNET ของจุฬาลงกรณ์มหาวิทยาลัย โดยมีการเข้าถึงข้อมูล ได้แก่ ชื่อ นามสกุล รหัสประจำตัวนิสิต และชั้นปีของท่าน รวมถึงคณะที่ท่านสังกัด',
    ...
    '5. เมื่อท่านทำการใช้สิทธิเลือกตั้ง กวศ. จะทำการบันทึกการลงคะแนนของท่านไว้ในระบบ เพื่อไม่ให้เกิดการลงคะแนนเสียงซ้ำ แต่จะไม่สามารถตรวจสอบย้อนหลังได้ว่าท่านได้ลงคะแนนให้กับหมายเลขใด',
    ...
    '7. กวศ. เป็นผู้ถือครองสิทธิในข้อมูลที่อยู่ในระบบของ กวศ. ซึ่งรวมไปถึง (แต่ไม่จำกัดเพียง) ข้อมูลผลคะแนนการเลือกตั้ง และรายชื่อผู้มาใช้สิทธิเลือกตั้ง โดย กวศ. จะเปิดเผยข้อมูลผลคะแนนการเลือกตั้ง และรายชื่อผู้มีสิทธิเลือกตั้ง แก่คณะกรรมการดำเนินการเลือกตั้งที่ได้รับมอบหมายให้รับผิดชอบในการอำนวยการเลือกตั้งในแต่ละครั้ง',
    '8. กวศ. ยึดถือว่า การยืนยันตัวตนด้วยรหัสประจำตัวนิสิต และรหัสผ่านระบบ CUNET ของท่าน ถือได้ว่าเป็นการยืนยันตัวตนที่เกิดจากตัวท่านเอง โดย กวศ. จะถือว่า การลงคะแนน หรือการกระทำอื่นใดในระบบภายหลังจากการยืนยันตัวตน เกิดขึ้นจากการกระทำด้วยตัวท่านเองโดยสมบูรณ์',
    '9. กวศ. อาจจัดเก็บข้อมูลการใช้งานผ่านระบบคอมพิวเตอร์ หรืออุปกรณ์เคลื่อนที่ที่ท่านใช้งานเว็บไซต์ เช่น หมายเลข IP ชนิดของบราวเซอร์ อุปกรณ์ที่ท่านเข้าถึงระบบของ กวศ. คุกกี้ เป็นต้น ทั้งนี้เพื่อความถูกต้องของข้อมูลของท่านในระบบของ กวศ.',
    '10. กวศ. จะพยายามอย่างยิ่งในการออกแบบระบบให้มีความปลอดภัยสูงที่สุด เพื่อไม่ให้ข้อมูลส่วนตัวของท่านที่อยู่ในระบบของ กวศ. เผยแพร่ออกไปสู่สาธารณชนโดยไม่ได้รับอนุญาตจากเจ้าของข้อมูล',
  ]
